...
Notesware.CategoriaCadastroRapido = (function() {
	...
	function onCategoriaSalva(categoria) {
		...
		comboCategoria.append('<option value=' + categoria.codigo + '>' + categoria.nome
				+ '</option>');
...
$(function() {
	var categoriaCadastroRapido = new Notesware.CategoriaCadastroRapido();
