package com.camilo.anotacoes.controller.page;
...
public class PageWrapper<T> {
	...
	public PageWrapper(Page<T> page, HttpServletRequest httpServletRequest) {
		...
		// Na url da pesquisa, o Spring transforma os espaços em branco em
		// sinais de "+" (é um bug já relatado e ainda não resolvido)
		// Este trecho de código serve para substituir os "+" por "%20", na url
		// da pesquisa.
